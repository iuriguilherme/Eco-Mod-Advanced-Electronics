...
namespace Eco.Mods.TechTree
{
    ...
    /// <see cref="HarvestDroneObject"/> below for the physical roaming WorldObject a dock
    /// dispatches.
    /// </summary>
    [Serialized]
    [Weight(500)]
    ...
    /// of. <see cref="HarvestDroneObject"/> follows the same pattern: implement neither,
    ...
    public partial class HarvestDroneObject : WorldObject
    {
        ...
        /// </summary>
        static HarvestDroneObject()
        {
            AddOccupancy<HarvestDroneObject>(new List<BlockOccupancy>
            {
        ...
        /// <see cref="HarvestDroneObject"/> itself does not need to know about the
    ...
    public partial class HarvestDroneRecipe : RecipeFamily
    {
        ...
        public HarvestDroneRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new CraftingElement<HarvestDroneItem>(1),
                });
